...
using WebAppUsingDBFirstApproach.Models;

namespace WebAppUsingDBFirstApproach.Controllers
{
    public class StandardsController : Controller
    {
        private readonly EfCoreContext _context;

        public StandardsController(EfCoreContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("StandardId,StandardName,Description")] Standard standard)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("StandardId,StandardName,Description")] Standard standard)
        {
